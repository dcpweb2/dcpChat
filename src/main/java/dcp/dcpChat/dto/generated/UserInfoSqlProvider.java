...
import dcp.dcpChat.dto.generated.UserInfoExample.Criteria;
import dcp.dcpChat.dto.generated.UserInfoExample.Criterion;
...
public class UserInfoSqlProvider {
    ...
    public String insertSelective(UserInfo record) {
        ...
        if (record.getRegisterDatetime() != null) {
            sql.VALUES("register_datetime", "#{registerDatetime,jdbcType=TIMESTAMP}");
        }
        ...
        if (record.getUnsubscribeFlg() != null) {
            sql.VALUES("unsubscribe_flg", "#{unsubscribeFlg,jdbcType=TINYINT}");
        }
    ...
    public String selectByExample(UserInfoExample example) {
        ...
        sql.SELECT("mail_address");
        sql.SELECT("password");
        sql.SELECT("register_datetime");
        sql.SELECT("update_datetime");
        sql.SELECT("unsubscribe_flg");
        sql.FROM("user_info");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getMailAddress() != null) {
            sql.SET("mail_address = #{record.mailAddress,jdbcType=VARCHAR}");
        }
        ...
        if (record.getRegisterDatetime() != null) {
            sql.SET("register_datetime = #{record.registerDatetime,jdbcType=TIMESTAMP}");
        }
        ...
        if (record.getUnsubscribeFlg() != null) {
            sql.SET("unsubscribe_flg = #{record.unsubscribeFlg,jdbcType=TINYINT}");
        }
    ...
    public String updateByPrimaryKeySelective(UserInfo record) {
        ...
        if (record.getRegisterDatetime() != null) {
            sql.SET("register_datetime = #{registerDatetime,jdbcType=TIMESTAMP}");
        }
        ...
        if (record.getUnsubscribeFlg() != null) {
            sql.SET("unsubscribe_flg = #{unsubscribeFlg,jdbcType=TINYINT}");
        }
